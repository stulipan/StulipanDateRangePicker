// The content of this was moved to daterangepicker.js on Sep 13, 2023. It is no longer maintained.
// I'm keeping it for local history purposes.
// !! It'll be removed within weeks or months. !!


(function (root, factory) {
    if (typeof module === 'object' && module.exports) {
        // Node.js/CommonJS
        module.exports = factory(require('moment')); // Add any other dependencies if needed
    ...
    var DateRangePicker = function(element, options, cb)
    {
        ...
        this.clickDate = function(e, cell) {
            ...
            setTimeout(function() {
                // focusables = this.container.querySelectorAll('.cell[tabindex="0"]');
                // console.log(cell);
                // console.log(this.container.querySelector('.cell[tabindex="0"]'));
                this.container.querySelector('.cell[tabindex="0"]').focus();
                // this.container.querySelector('.prev.available').focus();
            }.bind(this), 150);
        ...
        this._navigateDate = function(e, cell) {
            if (13 === e.keyCode || 37 === e.keyCode || 39 === e.keyCode || 38 === e.keyCode || 40 === e.keyCode) {
                ...
                // console.log(newDate.format(this.locale.format));
    ...
    // DateRangePicker.defaultOptions = {
    //     // Default options here
    // };


    function initDrp(options, callback) {
        var implementOptions = Object.assign({}, initDrp.defaultOptions, options);
        ...
        this.forEach(function(element) {
            ...
            let selector = element.tagName.toLowerCase() + (element.id ? '#' + element.id : '') + (element.className ? '.' + element.className.replace(/\s+/g, '.') : '');
            element.daterangepicker = new DateRangePicker(selector, implementOptions, callback);
        });
